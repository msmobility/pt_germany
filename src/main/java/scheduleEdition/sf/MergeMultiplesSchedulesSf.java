...
public class MergeMultiplesSchedulesSf {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < args.length; i++){
            ...
            new TransitScheduleReader(scenario).readFile("./matsim/" + args[i] + "/schedule.xml");
            TransitSchedule schedule = scenario.getTransitSchedule();
            schedule = addSuffixToScheduleElements(schedule, "_" + args[i]);
         ...
         */
        new TransitScheduleWriter(mergedSchedule).writeFile("./matsim/schedule.xml");

        Vehicles vehicles = VehicleUtils.createVehiclesContainer();
        createVehiclesForSchedule(mergedSchedule, vehicles);
        new VehicleWriterV1(vehicles).writeFile("./matsim/vehicles.xml");

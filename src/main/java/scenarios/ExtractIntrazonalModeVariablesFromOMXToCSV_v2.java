...
public class ExtractIntrazonalModeVariablesFromOMXToCSV_v2 {


    String inputMatrixTrain1 = "c:/models/transit_germany/output/skims/ld_bus_v3/ld_bus_v3_matrices.omx";
    String inputMatrixTrain2 = "c:/models/transit_germany/output/skims/ld_train_with_walk/ld_train_with_walk_matrices.omx";
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ExtractIntrazonalModeVariablesFromOMXToCSV_v2 dataExtractor = new ExtractIntrazonalModeVariablesFromOMXToCSV_v2();
        dataExtractor.readInput();
        dataExtractor.runAnalysis(1.0, "c:/projects/bast_entlastung/analysis/ld_model_analysis/scenarios/intrazonals_bus_vs_rail_with_walk.csv");
